			...
			import { STLLoader } from '../module/STLLoader.js';
			...
			function init() {
				...
				const plane = new THREE.Mesh(
					...
					new THREE.MeshPhongMaterial( { color: 0xA6A6A6, specular: 0x7E84F7 } )
				);
				...
				loader.load( '../stl/GrootBottom.stl', function ( geometry ) {

					const material = new THREE.MeshPhongMaterial( { color: 0x784315, specular: 0x111111, shininess: 200 } );
					const mesh = new THREE.Mesh( geometry, material );

					mesh.position.set( -0.23, -0.050, -0.65 );
					mesh.rotation.set( Math.PI / 2, 0, 3 );
				...
				loader.load( '../stl/GrootTop.stl', function ( geometry ) {

					const mesh = new THREE.Mesh( geometry, material );

					mesh.position.set( 0.136, -0.05, - 0.70 );
